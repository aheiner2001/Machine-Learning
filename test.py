...
def main():
    try:
        with open('pizza.csv', 'a', newline='') as csvfile:
            field_names = ['rest_time_before_fridge_hours', 'ball_tightness', 'time_in_fridge_days', 'bake_day_sit_time_hours', 'bake_day_sit_method', 'bake_day_reball', 'result_texture','result_overall']
